...
class __TwigTemplate_bc4bff5ca7d7a8e7b9702c0a5b1073a3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Oups... une erreur a eu lieu";
    ...
    public function block_header($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        $this->loadTemplate("layouts/header/_login_navbar.html.twig", "@Twig/Exception/error.html.twig", 6)->display($context);
    ...
    <div class=\"alert alert-danger icon-left\">
        ...
        <span>";
        // line 21
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 21, $this->source); })()), "html", null, true);
        echo " (status_code : ";
    ...
    <div class=\"home-link-container\">
        <a class=\"home-link icon-left\" href=\"";
        // line 24
...
";
    ...
    public function block_error_title($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_5a27a8ba21ca79b61932376b2fa922d2 = $this->extensions["Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension"];
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "error_title"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "error_title"));
    ...
    {
        return array (  169 => 15,  151 => 24,  143 => 21,  136 => 16,  134 => 15,  131 => 14,  121 => 13,  102 => 9,  91 => 6,  81 => 5,  62 => 3,  39 => 1,);
    }
...
{% block title %}Oups... une erreur a eu lieu{% endblock %}
...
{% block body %}
    <h1>
        {% block error_title %}Oups... Une erreur a eu lieu{% endblock %}
    </h1>
    <div class=\"alert alert-danger icon-left\">
        <svg class=\"icon i-left\">
            <use xlink:href=\"/svg/sprite.svg#error\"></use>
        </svg>
        <span>{{ status_text }} (status_code : {{status_code}})</span>
    </div>
    <div class=\"home-link-container\">
        <a class=\"home-link icon-left\" href=\"{{ path('home') }}\">
            <svg class=\"icon i-left\">
                <use xlink:href=\"/svg/sprite.svg#home_fill\"></use>
            </svg>
            <span>Retour à l'accueil</span>
...
{% endblock %}", "@Twig/Exception/error.html.twig", "C:\\Users\\Vico\\Desktop\\Noalia fée des gateaux (dossier complet)\\noaliafeedesgateaux\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
