...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\CakeSearchFilterType' => ['privates', 'App\\Form\\CakeSearchFilterType', 'getCakeSearchFilterTypeService', true],
            'App\\Form\\CakeType' => ['privates', 'App\\Form\\CakeType', 'getCakeTypeService', true],
            'App\\Form\\OrderSearchFilterType' => ['privates', 'App\\Form\\OrderSearchFilterType', 'getOrderSearchFilterTypeService', true],
            'App\\Form\\PasswordCreateType' => ['privates', 'App\\Form\\PasswordCreateType', 'getPasswordCreateTypeService', true],
            'App\\Form\\PasswordUpdateType' => ['privates', 'App\\Form\\PasswordUpdateType', 'getPasswordUpdateTypeService', true],
            'App\\Form\\UserExistType' => ['privates', 'App\\Form\\UserExistType', 'getUserExistTypeService', true],
            'App\\Form\\VisitSearchFilterType' => ['privates', 'App\\Form\\VisitSearchFilterType', 'getVisitSearchFilterTypeService', true],
            ...
            'App\\Form\\CakeSearchFilterType' => '?',
            'App\\Form\\CakeType' => '?',
            'App\\Form\\OrderSearchFilterType' => '?',
            'App\\Form\\PasswordCreateType' => '?',
            'App\\Form\\PasswordUpdateType' => '?',
            'App\\Form\\UserExistType' => '?',
            'App\\Form\\VisitSearchFilterType' => '?',
