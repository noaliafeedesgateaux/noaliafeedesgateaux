 ...
 */
class getVichUploader_Listener_Clean_CakesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.cakes' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.cakes'])) {
            return $container->privates['vich_uploader.listener.clean.cakes'];
        }

        return $container->privates['vich_uploader.listener.clean.cakes'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('cakes', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
